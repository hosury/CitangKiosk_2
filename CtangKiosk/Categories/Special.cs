...
namespace CtangKiosk.Categories
{
    public partial class Special : UserControl
    {
        ...
        public Special(string category)
        {
            InitializeComponent();
        ...
        private void PopulateProducts(DataTable products)
        {
            foreach (DataRow row in products.Rows)
            {
                ...
                specialflow.Controls.Add(productPanel);
        ...
        private void specialflow_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            specialflow = new FlowLayoutPanel
            {
                Dock = DockStyle.Fill,
                AutoScroll = true,
                WrapContents = true,
