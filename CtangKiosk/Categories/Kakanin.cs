...
{
    public partial class Kakanin : UserControl
    {
        ...
        public Kakanin(string category)
        {
            InitializeComponent();
        ...
        private void PopulateProducts(DataTable products)
        {
            foreach (DataRow row in products.Rows)
            {
                ...
                kakaninflow.Controls.Add(productPanel);
        ...
        private void Kakanin_Load(object sender, EventArgs e)
        {
        ...
        {
            kakaninflow = new FlowLayoutPanel
            {
                Dock = DockStyle.Fill,
                AutoScroll = true,
                WrapContents = true,
