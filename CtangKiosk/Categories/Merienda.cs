...
{
    public partial class Merienda : UserControl
    {
        ...
        public Merienda(string category)
        {
            InitializeComponent();
        ...
        private void LoadKakaninProducts()
        {
            try
            {
                conn.Open();
        ...
        private void PopulateProducts(DataTable products)
        {
            foreach (DataRow row in products.Rows)
            {
                ...
                {
                    //productImage.Image = Properties.Resources.DefaultImage;
                ...
                meriendaflow.Controls.Add(productPanel);
        ...
        private void Merienda_Load(object sender, EventArgs e)
        {
            
        }

        private void meriendaflow_Paint(object sender, PaintEventArgs e)
        {
            meriendaflow = new FlowLayoutPanel
            {
                Dock = DockStyle.Fill,
                AutoScroll = true,
                WrapContents = true,
            ...
            this.Controls.Add(meriendaflow);
        }
